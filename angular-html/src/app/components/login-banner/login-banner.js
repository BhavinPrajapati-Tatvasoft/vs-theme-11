      ...
      animations: [
        {
          elements: {
            eCz3tS04MKp110: {
              transform: {
                data: {
                  o: { x: 207.3465, y: 190.188, type: "corner" },
                  t: { x: -207.346497, y: -190.187999 },
                },
                keys: {
                  r: [
                    { t: 0, v: 0, e: [0.47, 0, 0.745, 0.715] },
                    { t: 1000, v: 10 },
                    { t: 2000, v: 0 },
                  ],
                },
            ...
            eCz3tS04MKp113: {
              transform: {
                data: {
                  o: { x: 204.658676, y: 189.407, type: "corner" },
                  t: { x: -204.658673, y: -189.406997 },
                },
                keys: {
                  r: [
                    { t: 0, v: 0, e: [0.47, 0, 0.745, 0.715] },
            ...
            eCz3tS04MKp133: {
              transform: {
                data: { t: { x: -310.937241, y: -158.728759 } },
                keys: {
                  o: [
                    {
                      t: 0,
                      v: { x: 310.937241, y: 158.72876, type: "corner" },
                      e: [0.47, 0, 0.745, 0.715],
                    },
                    {
                      t: 1000,
                      v: { x: 316, y: 158.72876, type: "corner" },
                      e: [0.47, 0, 0.745, 0.715],
                    },
                    { t: 2000, v: { x: 310.94, y: 158.72876, type: "corner" } },
                  ],
                },
              },
            },
            eCz3tS04MKp138: {
              transform: {
                data: {
                  o: { x: 256.676, y: 63.857704, type: "corner" },
                  t: { x: -256.531414, y: -63.857693 },
                },
                keys: {
                  s: [
                    { t: 0, v: { x: 1, y: 1 }, e: [0.47, 0, 0.745, 0.715] },
                    {
                      t: 1000,
                      v: { x: 1.1, y: 1 },
                      e: [0.47, 0, 0.745, 0.715],
            ...
            eCz3tS04MKp172: {
              transform: {
                data: {
                  o: { x: 76.923853, y: 73.927633, type: "corner" },
                  t: { x: -76.923853, y: -73.927632 },
                },
                keys: {
                  s: [
                    { t: 0, v: { x: 0, y: 0 }, e: [0.47, 0, 0.745, 0.715] },
                    { t: 1000, v: { x: 1, y: 1 } },
                    { t: 2000, v: { x: 0.6, y: 0.6 } },
                  ],
                },
              },
            },
            eCz3tS04MKp186: {
              transform: {
                data: {
                  o: { x: 521.809649, y: 80.8605, type: "corner" },
                  k: { x: 10, y: -10 },
                  t: { x: -517.054981, y: -77.131625 },
                },
                keys: {
                  r: [
                    { t: 0, v: 0, e: [0.47, 0, 0.745, 0.715] },
            ...
            eCz3tS04MKp191: {
              transform: {
                data: {
                  o: { x: 519.448, y: 83.272339, type: "corner" },
                  t: { x: -519.448, y: -83.272339 },
                },
                keys: {
                  r: [
                    { t: 0, v: 0, e: [0.47, 0, 0.745, 0.715] },
          ...
          s: "|",
        },
      ],
      options: "MJDAxMFM4ODJmSDgwODDE2ZTdmODEyZjQ3MmYI3OTdjUTZlNzEyZjhhE",
    },
    "__SVGATOR_PLAYER__",
    window,
    document
